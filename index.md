...
<div class="hero">
  <div class="hero-text">
    <div class="tagline">Structural Analysis Engineer</div>
    <h1>Shishir Barai</h1>
    <p>
...
<div class="section">
  ...
  <div class="skills-grid">
    <div class="skill-card">
      ...
      <p>Abaqus, ANSYS, COMSOL, LS-DYNA, MOOSE — static, dynamic, multiphysics</p>
    </div>
    <div class="skill-card">
      <h4>Scripting & Automation</h4>
      <p>Python, PyAnsys, Abaqus scripting API — automated meshing, BCs, solvers, post-processing</p>
    </div>
    <div class="skill-card">
      <h4>Optimization & DOE</h4>
      <p>optiSLang, parametric design studies, surrogate modeling, design space exploration</p>
    </div>
    <div class="skill-card">
      <h4>ML for Simulation</h4>
      <p>CNNs, autoencoders, surrogate models — TensorFlow, PyTorch, HPC/Slurm</p>
    </div>
    <div class="skill-card">
      <h4>CAD & Modeling</h4>
      <p>SolidWorks, AutoCAD — geometry creation and parametric CAD workflows</p>
    </div>
    <div class="skill-card">
      <h4>Materials Modeling</h4>
      <p>Hyperelastic (Mooney-Rivlin, Ogden), composites, homogenization, RVE analysis</p>
    </div>
  </div>
</div>
...
<div class="section">
  ...
  <div class="exp-item">
    <div class="exp-header">
      ...
      <div class="exp-meta">May 2025 – Aug 2025<br>Wilton, CT</div>
    </div>
    <ul>
      ...
      <li>Scripted meshing, boundary conditions, solver settings, and post-processing using Python's Abaqus API.</li>
...
<div class="section">
  ...
  <div class="project-card">
    <div class="project-header">
      <div class="project-title">Automated Parametric FEA Pipeline — ASML</div>
      <div class="tags">
        <span class="tag">Abaqus</span>
        <span class="tag">optiSLang</span>
        <span class="tag">Python</span>
        <span class="tag">DOE</span>
      </div>
    </div>
    <ul>
      <li>Designed end-to-end automation connecting CAD generation → meshing → multiphysics simulation → performance evaluation.</li>
      <li>40 parametric design variables with flexible constraint system for efficient design space exploration.</li>
      <li>Integrated optiSLang for automated DOE, parameter sampling, and surrogate-based optimization.</li>
      <li>Framework is modular and reusable — applicable beyond EUV nozzle to general CAD-simulation workflows.</li>
    </ul>
  </div>

  <div class="project-card">
    <div class="project-header">
      <div class="project-title">Python-Based Multiscale Material Calibration — Ansys</div>
      <div class="tags">
        <span class="tag">PyAnsys</span>
        <span class="tag">PBC</span>
        <span class="tag">Hyperelastic</span>
        <span class="tag">OOP</span>
      </div>
    </div>
    <ul>
      <li>Built an object-oriented Python class wrapping PyAnsys MAPDL for automated nonlinear RVE simulations.</li>
      <li>Implemented periodic boundary conditions using constraint equations to simulate infinite material behavior.</li>
      <li>Extracted and calibrated stress-strain data for Mooney-Rivlin and Ogden models via Ansys Material Library.</li>
      <li>Verified homogenized parameters by re-running simulations on new RVE configurations.</li>
    </ul>
  </div>
  ...
  <div class="project-card">
    ...
    <ul>
      ...
      <li>Captured full displacement field data as training datasets for downstream ML surrogate models.</li>
    </ul>
  </div>
  ...
  <div class="project-card">
    ...
    <ul>
      ...
      <li>Built a convolutional autoencoder to compress FEA datasets by <strong>94%</strong>, drastically reducing storage and training costs.</li>
...
<div class="section">
  ...
  <div class="pub-item">
    ...
    <a href="https://scholar.google.com/citations?user=L8pNussAAAAJ" target="_blank">[Link]</a>
  </div>
  ...
  <div class="collab-box">
    <div>
      ...
      <p>
        ...
        I'm always open to collaborating on research or industry projects at the intersection of
